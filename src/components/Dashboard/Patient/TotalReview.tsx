...
interface TotalReviewersProps {
  totalReview: number;
  capacity: number;
  label: string;
}

export const TotalReview: React.FC<TotalReviewersProps> = ({
  totalReview,
  capacity,
  label,
}) => {
  const data = [
    { name: "Completed", value: totalReview },
    { name: "Remaining", value: capacity - totalReview },
  ];
