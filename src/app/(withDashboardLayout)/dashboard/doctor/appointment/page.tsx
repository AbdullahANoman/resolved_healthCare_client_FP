...
import { Video, Calendar, User, Phone, DollarSign, Clock } from "lucide-react";
import { DataTable } from "@/components/Shared/DataTable/DataTable";
import { TableSkeleton } from "@/components/Shared/DataTable/TableSkeleton";
// import { dateFormatter } from "@/utils/dateFormatter";
// import { getTimeIn12HourFormat } from "@/utils/timeFormatter";
  ...
  return (
    <div>
      <DataTable
        ...
        tableSubTitle="Manage and track your patient appointments"
        filters={[
          {
            columnId: "status",
      ...
      >
        {/* You can add additional buttons here like Create Appointment, etc. */}
      </DataTable>
    </div>
  );
};
